...
if ($result->num_rows > 0) {
	while($row = $result->fetch_assoc()) {
		if($row_cnt==1){
			$content .= '<div style="text-align:right;margin-bottom: 10px; font-weight:600; font-size: 35px;color:rgb(181,15,25);">'.$row["projectName"].'</div><div class="projects-back"><div style="width:550px; height:450px;float: left;overflow: hidden;display: block;padding: 10px;background-color: #e6e6e6;" >';
		...
		$content .= '<img src="/angan/'.$row["image"].'" alt="" style="height: 100%;width:auto; ">';
